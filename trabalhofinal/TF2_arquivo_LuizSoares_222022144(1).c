    ...
    do
    {
        ...
        case 1:
            do
            {
                ...
                fwrite(&cursos, sizeof(curso), 1, arquivo);
            } while (continuar());
            break;
        case 0:
            printf("Saindo...\n");
...
// Parâmetros: Arquivo para verificar o CIC do curso
...
curso cadastrarCurso(FILE *arquivo)
{
    ...
    // Gravar os dados do curso no arquivo
    fwrite(&novoCurso, sizeof(novoCurso), 1, arquivo);
...
// Função       : abrirArquivo
// Objetivo     : Abrir o arquivo binário
// Parâmetros   : Nenhum
// Saída        : Nenhuma
FILE *abrirArquivo()
{
...
// Objetivo     : Fechar o arquivo binário
// Parâmetros   : Nenhum
// Saída        : Nenhuma
